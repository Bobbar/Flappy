...
namespace Flappy
{
    public partial class Form1 : Form
    {
        ...
        {
            _device?.Dispose();
            _device = D2DDevice.FromHwnd(this.Handle, D2D1PresentOptions.None);
            ...
            _viewPortSize = new D2DSize(this.Width, this.Height);
            _device.Resize();
        ...
        private void InitGameObjects()
        {
            ...
            _birbFlapAnim = new FlapAnimation(_birb, 0, -25, 400, EasingFunctions.EaseQuinticOut);
        ...
        private void RenderLoop()
        {
            ...
            while (!this.Disposing)
            {
                ...
                var dt = (td / (float)TimeSpan.TicksPerMillisecond) * DT;
                ...
                _gfx.Antialias = true;
                _gfx.DrawStrokedText($"{_score}", this.Width * 0.5f, 60f, D2DColor.Black, 1.5f, D2DColor.White, "Consolas", 35f);
                _gfx.Antialias = false;
        ...
        {
            var newSize = new D2DSize(this.Width, this.Height);

            if (_viewPortSize.width != newSize.width || _viewPortSize.height != newSize.height)
            {
        ...
        private void DrawCollisionMask()
        {
            ...
            {
                var transPnt = Vector2.Transform(pnt, mat);
                _gfx.FillRectangle(new D2DPoint(transPnt.X, transPnt.Y), new D2DSize(3f, 3f), D2DColor.Red);
            }
        }
        ...
        private void SpawnPipes()
        {
            ...
            if (dist >= PIPE_SPACING + _nextPipeVariation)
            {
